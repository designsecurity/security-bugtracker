...
$CONF_WEBISSUES_FOLDER_SCANS = 2;
$CONF_WEBISSUES_FOLDER_BUGS = 1;
$CONF_WEBISSUES_FOLDER_WEB = 5;
$CONF_WEBISSUES_FOLDER_CODES = 4;
$CONF_WEBISSUES_FOLDER_SERVERS = 3;
...
$ASSETS_SERVERS_PROJECTS = "./assets/servers_projects.txt";
