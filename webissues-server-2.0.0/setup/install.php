...
class Setup_Install extends System_Web_Component
{
    ...
    protected function execute()
    {
        if ( $this->checkAccess() ) {
            ...
            $this->form->addPersistentField( 'host', getenv("MYSQL_HOST") );
            $this->form->addPersistentField( 'database', getenv("MYSQL_DATABASE") );
            $this->form->addPersistentField( 'user', getenv("MYSQL_USER") );
            $this->form->addPersistentField( 'password', getenv("MYSQL_PASSWORD") );
